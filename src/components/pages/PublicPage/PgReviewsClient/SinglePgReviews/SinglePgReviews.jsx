...
const SinglePgReviews = ({ d }) => {
    const [isReadMore, setIsReadMore] = useState(true);
    const toggleReadMore = () => {
        setIsReadMore(!isReadMore);
    };
    return (
        <div className="w-[250px] xxs:w-[350px] xs:w-[470px] md:w-[640px] p-3 xxs:p-5 bg-[#fbfbfb] rounded-md md:rounded-lg border hover:shadow-sm">
...
export default SinglePgReviews;