...
const TermsAndCondition = () => {
    return (
        <div className="bg-[#fbfbfb] pb-32 pt-[140px] xxs:pt-[192px] lg:pt-[202px] xl:pt-[228px] 3xl:pt-[234px]">
            <div className="mx-auto max-w-screen-4xl px-2 xxs:px-[16px] sm:px-[32px] 2xl:px-[20]">
                <div className='flex flex-col lg:flex-row items-center'>
                    ...
                    <div className='mt-24 xs:mt-32 lg:mt-0 lg:w-[50%] lg:ml-10'>
                        <h2 className='text-center lg:text-left text-base xxs:text-xl xs:text-2xl md:text-4xl font-bold text-black mb-5 xs:mb-7 md:mb-10'>Terms And Conditions</h2>
