...
// import url from '../../../../../assets/images/world-explore-bg.jpg';
    ...
    return (
        <div className="bg-[#fbfbfb] h-full w-full pt-12 xxs:pt-18 md:pt-24 2xl:pt-48 relative overflow-hidden">
            <div className="bg-worldExploreBg bg-cover bg-no-repeat bg-fixed w-full h-full bg-center">
                ...
                <div className="relative py-12 xxs:py-18 md:py-24 2xl:py-32 px-2 xxs:px-[16px] sm:px-[32px] mx-auto xxs:max-w-screen-xs xs:max-w-screen-sm sm:max-w-screen-md md:max-w-screen-lg lg:max-w-screen-xl xl:max-w-screen-2xl 2xl:max-w-screen-3xl 3xl:max-w-screen-4xl">
