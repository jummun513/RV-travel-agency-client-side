                ...
                <div className='grid grid-cols-2 gap-x-5 mt-7'>
                    ...
                    <div className="mb-3 sm:mb-0 w-full sm:mr-5 2xl:mr-10 text-gray-600 group z-0">
                        ...
                        <input
                            ...
                            onChange={(e) => handleInputChange('price', index, e)} onWheel={(e) => e.target.blur()} type="number" pattern="[0-9]*" inputMode="numeric" placeholder='2000' className="mt-1 input input-bordered input-info input-xs xxs:input-sm xl:input-md text-gray-950 bg-white w-full" />
                    </div>
                    {/* price */}
                    <div className="mb-3 sm:mb-0 w-full sm:mr-5 2xl:mr-10 text-gray-600 group z-0">
                        ...
                        <input
                            ...
                            value={moreData[index]?.discountPrice}
                            onChange={(e) => handleInputChange('discountPrice', index, e)} onWheel={(e) => e.target.blur()} type="number" pattern="[0-9]*" inputMode="numeric" placeholder='2000' className="mt-1 input input-bordered input-info input-xs xxs:input-sm xl:input-md text-gray-950 bg-white w-full" required />
                    </div>
                </div>
                <div className='grid grid-cols-3 gap-x-5 mt-7'>
                    ...
                    <div className="mb-3 sm:mb-0 w-full sm:mr-5 2xl:mr-10 text-gray-600 group z-0">
                        ...
                        <input
                            ...
                            onChange={(e) => handleInputChange('sleep', index, e)} onWheel={(e) => e.target.blur()} type="number" pattern="[0-9]*" inputMode="numeric" placeholder='2' className="mt-1 input input-bordered input-info input-xs xxs:input-sm xl:input-md text-gray-950 bg-white w-full" required />
                    </div>
                    {/* size field */}
                    <div className="mb-3 sm:mb-0 w-full sm:mr-5 2xl:mr-10 text-gray-600 group z-0">
