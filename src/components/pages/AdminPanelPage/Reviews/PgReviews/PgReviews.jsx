...
const PgReviews = () => {
    ...
    const handleSearchField = (event) => {
        ...
        const results = pgReviews?.filter(d => (d.userId.fullName.toLowerCase().includes(keyword)));
                ...
                <div>
                    <div className="flex flex-col xxs:flex-row justify-between items-center">
                        <div className="w-2/5 me-5">
                            <p className="text-center xxs:text-left my-4 font-semibold text-gray-800 xxs:text-base xs:text-xl">Total : {searchKeyword ? searchData?.length : pgReviews?.length}</p>
                        </div>
                        <div className="w-3/5">
                            <form>
                                <div className="flex">
                    ...
                    <div className="mt-10">
                        <div className="relative overflow-x-auto sm:overflow-x-hidden shadow-md sm:rounded-lg lg:min-w-[720px]">
                            <table className="w-full text-sm text-left text-gray-500">
                                ...
                                <tbody>
                                    {
                                        (searchKeyword ? searchData : pgReviews)?.map((d, i) => {
                                            return (
