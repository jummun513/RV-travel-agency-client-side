        ...
        <div className="relative top-[45px] xxs:top-[64px] lg:top-[74px] xl:top-[100px] 3xl:top-[106px] mb-[45px] xxs:mb-[64px] lg:mb-[74px] xl:mb-[100px] 3xl:mb-[106px]">
            <div className="bg-login-back w-full h-full bg-cover bg-no-repeat bg-center">
                <div className="w-full h-full flex items-center backdrop-blur-sm 4xl:backdrop-blur-md">
                    <div className={`overflow-hidden flex w-full h-full my-16 rounded-lg sm:rounded-xl lg:rounded-2xl bg-login-front bg-cover bg-no-repeat bg-center mx-2 xxs:mx-5 xs:mx-auto min-w-[250px] xs:max-w-screen-xxs sm:max-w-screen-xs md:max-w-screen-sm lg:max-w-screen-md xl:max-w-screen-lg 2xl:max-w-screen-xl 3xl:max-w-screen-2xl 4xl:max-w-screen-3xl ${location.pathname.includes('login') ? 'flex-row-reverse' : 'flex-row'}`}>
